...
2. Ask the user for a final truthfulness confirmation bound to the exact ready application. If the user attached a resume manually, separately ask them to confirm the visible filename is their intended attachment; keep that browser-local upload explicitly unbound and outside the truth certification.
